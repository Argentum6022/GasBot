...
async def process_help_command(message: types.Message):
    await message.reply("Для того чтобы начать сначала напишите /start "
                        ...
                        "\nРеализован рейтинговый поиск двумя методами. Если вы точно знаете чего хотите, воспользуйтесь поиском  \"По названию\""
                        " и введите ключевые слова. Если необходим поэтапный подбор, воспользуйтесь поиском \"По каталогу\" "
                        "и следуйте инструкциям. Уверен вы найдёте то, что искали!")
